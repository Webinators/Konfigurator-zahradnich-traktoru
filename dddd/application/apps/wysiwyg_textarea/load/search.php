...
echo ' <img src="logged/wysiwyg_textarea/ikonka/sipka.png"/> <a style="cursor: pointer;" class="linknavigation" onmouseover="this.className=\'linknavigationpo\'" onmouseout="this.className=\'linknavigation\'" onclick="movetofolder(\''.$link.'\')">'.$explode[$i].'</a>';
}
...
{
$checked = strtolower($soubor);

if (strpos($checked, $keyword) !== FALSE)
{
echo'
<div class="seznamsouboru" id="'.$i.'" onmousedown="zobrazpravymkliknutim(\''.$i.'\',\'pravyklikmenu'.$i.'\',\''.$soubor.'\')" ondblclick="zobrazobsahslozky(\''.$soubor.'\')" onmouseover="nastavstyldivu(\''.$i.'\')" onmouseout="zrusstyldivu(\''.$i.'\')"> <a style="cursor: pointer;"><img src="logged/wysiwyg_textarea/ikonka/folder.png" height="60px"/></a><div class="nazevobr"><div id="foldername'.$i.'"><a onclick="zobrazobsahslozky(\''.$soubor.'\')" style="cursor: pointer;">'.$soubor.'</a></div></div></div>
...
<div class="seznamsouboru" id="'.$i.'" onmousedown="zobrazpravymkliknutim(\''.$i.'\',\'pravyklikmenu'.$i.'\',\''.$soubor.'\')" onmouseover="nastavstyldivu(\''.$i.'\')" onmouseout="zrusstyldivu(\''.$i.'\')"><a style="cursor: pointer;"><center><img src="logged/wysiwyg_textarea/obrazky'.$cestakobr.''.$soubor.'" height="60px"/></center></a><a id="insert'.$i.'" class="insert" style="display: none;" onclick="vlozobrdotextarey(\'popis\',\'logged/wysiwyg_textarea/obrazky'.$cestakobr.''.$soubor.'\')">vložit</a><div class="nazevobr"><div id="filename'.$i.'"><a style="cursor: pointer;">'.$soubor.'</a></div></div></div>
